...
class Bot extends Discord.Client {
  constructor(options) {
    ...
    fs.createReadStream(`${__dirname}/../song.mp3`).on("error", () =>
      this.downloadMusic(this.ff_music, 9, "song")
    );
  }
  ...
  downloadMusic(link, duration, outputname) {
    ...
    let out = fs.createWriteStream(`${__dirname}/../${outputname}.mp3`);
